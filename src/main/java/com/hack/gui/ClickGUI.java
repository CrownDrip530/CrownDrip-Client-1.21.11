...
public class ClickGUI extends Screen {
    ...
    public ClickGUI() { super(Text.literal("CrownDrip Client")); }
    ...
    private void drawTabs(DrawContext ctx, int sw, int mx, int my) {
    ...
    private void drawFlat(DrawContext ctx, int mx, int my, List<HackModule> list) {
        int sw   = width;
    ...
    private void drawColumns(DrawContext ctx, int mx, int my, List<HackModule> list) {
        int sw = width;
    ...
    private int drawRow(DrawContext ctx, int mx, int my,
