...
public class PlayerESP extends HackModule {
    ...
    public void renderHud(DrawContext ctx) {
        ...
        for (PlayerEntity player : mc.world.getPlayers()) {
            ...
            Vec3d top    = new Vec3d(player.getX(), bb.maxY + 0.1, player.getZ());
            Vec3d bottom = new Vec3d(player.getX(), bb.minY - 0.1, player.getZ());
    ...
    public int[] worldToScreen(Vec3d worldPos) {
